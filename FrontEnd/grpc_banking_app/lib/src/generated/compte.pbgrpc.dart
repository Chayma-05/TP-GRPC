...
@$pb.GrpcServiceName('ma.projet.grpc.stubs.CompteService')
class CompteServiceClient extends $grpc.Client {
  ...
  static final _$comptesByType = $grpc.ClientMethod<$0.GetComptesByTypeRequest, $0.GetComptesByTypeResponse>(
  ...
  $grpc.ResponseFuture<$0.GetComptesByTypeResponse> comptesByType($0.GetComptesByTypeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$comptesByType, request, options: options);
  }
...
abstract class CompteServiceBase extends $grpc.Service {
  $core.String get $name => 'ma.projet.grpc.stubs.CompteService';
  ...
  $async.Future<$0.GetComptesByTypeResponse> comptesByType_Pre($grpc.ServiceCall call, $async.Future<$0.GetComptesByTypeRequest> request) async {
    return comptesByType(call, await request);
  }
  ...
  $async.Future<$0.GetComptesByTypeResponse> comptesByType($grpc.ServiceCall call, $0.GetComptesByTypeRequest request);
